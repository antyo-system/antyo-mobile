...
const SLIDES = [
  ...
  },
  {
    ...
    subtitle: 'A brutally honest calendar that compares what you planned vs what you actually did.',
    icon: 'columns',
    color: 'text-gray-900 dark:text-white',
    bg: 'bg-gray-100 dark:bg-gray-800',
  },
  {
    ...
    subtitle: 'Connect your goals to your calendar in one click. Zero friction.',
    icon: 'zap',
    color: 'text-gray-900 dark:text-white',
    bg: 'bg-gray-100 dark:bg-gray-800',
  }
